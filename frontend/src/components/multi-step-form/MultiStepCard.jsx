                ...
                <div
                  ...
                  onClick={() => {
                    if (!isDisabled && !isSelected) {
                      // ✅ Only add if not already selected (no remove)
                      toggleModelSelection(
                        model,
                        addModelToScene,
                        getAddedQuantity,
                    ...
                    <div className="accordion-body">
                      {matchingExtensions.map((ext) => {
                        ...
                        return (
                          <div
                            key={ext.label}
                            className={`bbv-parts clickable-card mb-2 ${
                              isExtSelected ? "selected-card" : ""
                            } ${
                              isExtDisabled
                            ...
                            onClick={() => {
                              if (!isExtDisabled && !isExtSelected) {
                                // ✅ Only add if not already selected (no remove)
                                toggleModelSelection(
                                  ext,
                                  addModelToScene,
                          ...
                          >
                            ...
                            {isExtSelected && (
                              <span className="badge bg-success added-badge">
                                added
                              </span>
                            )}
                          </div>
