...
//   // console.log("Van Model Loaded:", nodes);
//   useFrame(() => {
...
export default function VanModel({ showExterior }) {
  ...
  const models = {
    ...
    Pebble: "/models/AllColorGLB144/Van_Pebble.glb",
    Stone_Grey: "/models/AllColorGLB144/Van_StoneGrey.glb",
    Graphite_Grey: "/models/AllColorGLB144/Van_GraphiteGrey.glb", // ✅ default
  };

  // ✅ Default to Graphite Grey if nothing is selected
  const selectedModelPath = models[formattedVanName] || models["Graphite_Grey"];
  const { nodes, materials } = useGLTF(selectedModelPath);
